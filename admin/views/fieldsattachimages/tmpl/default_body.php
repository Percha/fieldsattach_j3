...
<?php foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td>
			<a class="modal" rel="{handler: \'iframe\', size: {x: 980, y: 500}}" href="<?php echo JRoute::_('index.php?option=com_fieldsattach&task=fieldsattachimage.edit&id=' . $item->id.'&tmpl=component'); ?>">
				<?php echo $item->title; ?>
			</a>
		</td>
                <td class="order">
