 ...
 * fieldsattach Model
 */
class fieldsattachModelfieldsattachimage extends JModelAdmin
{
	...
	public function getTable($type = 'fieldsattachimage', $prefix = 'fieldsattachTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_fieldsattach.fieldsattachimage', 'fieldsattachimage', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_fieldsattachimage.edit.fieldsattachimage.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
