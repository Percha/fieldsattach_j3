	...
	setFolder: function(folder,asset,author)
	{
		...
		for(var i = 0; i < this.folderlist.length; i++)
		{
			if(folder == this.folderlist.options[i].value) {
                ...
                document.id("f_url").value = folder;
		this.frame.location.href='index.php?option=com_fieldsattach&view=imagesList&only=folder&tmpl=component&folder=' + folder + '&asset=' + asset + '&author=' + author;
	},
