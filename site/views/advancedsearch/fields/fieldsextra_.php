...
$sitepath = JPATH_BASE ; 
//JLoader::register('FieldsattachHelper',  $sitepath.'/components/com_fieldsattach/helpers/fieldattach.php'); 
...
class JFormFieldFieldsextra extends JFormField
{
	...
	protected function getInput()
	{
	  ...
	  JFactory::getDocument()->addScriptDeclaration(implode("\n", $script));
          ...
          $html .= "\n".'<input type="text" id="jform_request_fields" name="jform_request_fields" value="'.$this->value.'" />';
